...
# JVM内存参数（堆 + 栈）
MAXHEAP="-Xms60g -Xmx60g -Xss2m -XX:+UseG1GC -XX:MaxGCPauseMillis=200 -XX:InitiatingHeapOccupancyPercent=30"

# 其他系统和应用参数，限制直接内存为2GB
OPTS_FROM_ORIENTDB="-Djna.nosys=true -XX:+HeapDumpOnOutOfMemoryError -XX:MaxDirectMemorySize=10g -Djava.awt.headless=true -Dfile.encoding=UTF8 -Drhino.opt.level=9"
